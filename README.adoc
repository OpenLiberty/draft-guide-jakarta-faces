...
The `styleClass`, `headerClass`, and `rowClasses` attributes in the [hotspot=dataBind file=0]`<h:dataTable>` tag specify the style classes in the [hotspot=systemLoadsTableClasses file=2]`src/main/webapp/resources/css/styles.css` file.
